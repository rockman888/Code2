package com.example.ae_23_addspritelist;
...
public class MainActivity extends BaseGameActivity {
	...
	public void onLoadResources() {
		...
		// load target
		this.mTextureTarget = new Texture(64, 64,
				TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		this.mTiledTextureRegion = TextureRegionFactory.createTiledFromAsset(
				this.mTextureTarget, this, "coca.png", 0, 0, 1, 1);
		this.mEngine.getTextureManager().loadTexture(this.mTextureTarget);
	}
	...
	public void add_Target(final Scene scene) {
		...
		AnimatedSprite target = new AnimatedSprite(x, y,
		...
		int maxDuration = 5; // tốc độ lon coca bay nhanh nhất
		...
		{
			MoveXModifier xMod = new MoveXModifier(actualDuration,
					target.getX(), CAMERA_WIDTH);
